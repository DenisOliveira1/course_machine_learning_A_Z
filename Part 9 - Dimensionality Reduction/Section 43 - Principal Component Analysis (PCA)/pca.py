...
# primeiro faz com n_components = None para ver o vetor de variancia dos principal component
X_train = pca.fit_transform(X_train)
X_test = pca.transform(X_test)
explained_variance = pca.explained_variance_ratio_
# 0.369 - o primeiro componente representa 36% da variancia
# 0.193 - o segundo componente representa 19% da variancia
# se usar os 2 primeiro vai representar 55% da variancia
# a soma de todas as representações dos componentes é igual a 100%
...
# para cada nova classe é necessario somente adicionar uma nova cor
